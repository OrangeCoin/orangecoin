...
static const int64 MAX_MONEY = 5000000000 * COIN; // maximum number of coins = 5B
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 1440 / 250; // 5760 blocks found a day. Priority cutoff is 1 OGC day / 250 bytes.
    }
